      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="px-6 pt-6 pb-4 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-bold text-gray-900">Large Dataset — Direct-to-File Mode</h2>
              <p className="text-xs text-gray-400 mt-0.5">{pairCount.toLocaleString()} pairs requested</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-4">
          ...
          {/* Format picker */}
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Choose output format</p>
